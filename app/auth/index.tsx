...
const MarqueeOnboarding: FC = () => {
  ...
  const [foreground, accent, accentForeground] = useThemeColor(["foreground", "accent", "accent-foreground"]);
    ...
    <ThemeView style={{ flex: 1 }}>
      <View className="flex-1">
        ...
        <View className="pb-6 px-6" style={{ paddingTop: Math.max(insets.top, 12) + 24 }}>
          <Text className="text-2xl font-bold text-center" style={{ color: foreground }}>
        ...
        <View className="px-6 pt-6" style={{ paddingBottom: Math.max(insets.bottom, 12) + 12 }}>
          <View className="gap-y-5">
            ...
            >
              <Text className="text-lg font-semibold" style={{ color: accentForeground }}>
                Get Started
              </Text>
            </Pressable>
