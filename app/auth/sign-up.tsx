...
export default function SignUp() {
  const [foreground, danger, accent, accentForeground] = useThemeColor(["foreground", "danger", "accent", "accent-foreground"]);
          ...
          <View className="flex-1 justify-center">
            ...
            <View className="gap-y-2">
                  ...
                  render={({ field: { onChange, onBlur, value } }) => (
                    <TextField className="w-full">
                      ...
                      <View style={{ position: "relative" }}>
                        ...
                        />
                        <View style={{ position: "absolute", left: 10, top: 12 }}>
                          <Ionicons name="lock-closed-outline" size={20} color={foreground} style={{ opacity: 0.7 }} />
                        </View>
                        <TouchableOpacity
                          onPress={async () => {
                      ...
                      {errors.password && (
                        <Description style={{ color: danger }}>{errors.password.message}</Description>
                      )}
                    </TextField>
                  )}
                />
                  ...
                  render={({ field: { onChange, onBlur, value } }) => (
                    <TextField className="w-full">
                      ...
                      {errors.confirmPassword && (
                        <Description style={{ color: danger }}>{errors.confirmPassword.message}</Description>
                      )}
                    </TextField>
                  )}
                />
              ...
              <Pressable
                ...
                disabled={isLoading}
              >
                <Text style={{ color: accentForeground }}>{isLoading ? "Creating Account..." : "Sign Up"}</Text>
              </Pressable>
            </View>
